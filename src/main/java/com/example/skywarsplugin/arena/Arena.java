...
public class Arena {
    ...
    public Arena(@NotNull ArenaData data, SkyWars plugin){
        this.plugin=plugin;
        name = data.name;
    ...
    private void drawBarrier(){
        ...
        worldcopy.spawnParticle(barrierParticle,barrierPos1.x,barrierPos1.y,(barrierPos1.z+barrierPos2.z)/2,300,0.2,0.2,barrierZWidth,0,null,true);
        worldcopy.spawnParticle(barrierParticle,barrierPos1.x,barrierPos2.y,(barrierPos1.z+barrierPos2.z)/2,300,0.2,0.2,barrierZWidth,0,null,true);

        worldcopy.spawnParticle(barrierParticle,barrierPos2.x,barrierPos1.y,(barrierPos1.z+barrierPos2.z)/2,300,0.2,0.2,barrierZWidth,0,null,true);
        worldcopy.spawnParticle(barrierParticle,barrierPos2.x,barrierPos2.y,(barrierPos1.z+barrierPos2.z)/2,300,0.2,0.2,barrierZWidth,0,null,true);

        worldcopy.spawnParticle(barrierParticle,(barrierPos1.x+barrierPos2.x)/2,barrierPos1.y,barrierPos1.z,300,barrierXWidth,0.2,0.2,0,null,true);
        worldcopy.spawnParticle(barrierParticle,(barrierPos1.x+barrierPos2.x)/2,barrierPos2.y,barrierPos1.z,300,barrierXWidth,0.2,0.2,0,null,true);

        worldcopy.spawnParticle(barrierParticle,(barrierPos1.x+barrierPos2.x)/2,barrierPos1.y,barrierPos2.z,300,barrierXWidth,0.2,0.2,0,null,true);
        worldcopy.spawnParticle(barrierParticle,(barrierPos1.x+barrierPos2.x)/2,barrierPos2.y,barrierPos2.z,300,barrierXWidth,0.2,0.2,0,null,true);

        worldcopy.spawnParticle(barrierParticle,barrierPos1.x,(barrierPos1.y+barrierPos2.y)/2,barrierPos1.z,300,0.2,barrierYWidth,0.2,0,null,true);
        worldcopy.spawnParticle(barrierParticle,barrierPos1.x,(barrierPos1.y+barrierPos2.y)/2,barrierPos2.z,300,0.2,barrierYWidth,0.2,0,null,true);

        worldcopy.spawnParticle(barrierParticle,barrierPos2.x,(barrierPos1.y+barrierPos2.y)/2,barrierPos1.z,300,0.2,barrierYWidth,0.2,0,null,true);
        worldcopy.spawnParticle(barrierParticle,barrierPos2.x,(barrierPos1.y+barrierPos2.y)/2,barrierPos2.z,300,0.2,barrierYWidth,0.2,0,null,true);
